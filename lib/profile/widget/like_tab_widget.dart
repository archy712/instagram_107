...
class LikeTabWidget extends StatelessWidget {
  // 좋아요 피드 리스트
  final List<FeedModel> likeFeedList;

  const LikeTabWidget({super.key, required this.likeFeedList});
  ...
  Widget build(BuildContext context) {
    return MasonryGridView.count(
      ...
      crossAxisSpacing: 2,
      mainAxisSpacing: 2,
      itemCount: likeFeedList.length,
      itemBuilder: (context, index) {
        final FeedModel feedModel = likeFeedList[index];
